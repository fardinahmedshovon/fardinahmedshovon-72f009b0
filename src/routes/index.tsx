            ...
            <div>
              <div className="mb-6 lg:mb-8">
                <img
                  ...
                  className="h-24 w-24 rounded-full border-2 border-slate-700/50 object-cover shadow-2xl grayscale transition-all duration-300 hover:scale-105 hover:border-teal-300/50 hover:grayscale-0"
                />
              </div>
