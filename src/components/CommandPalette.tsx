  ...
  return (
    <>
      <button
        ...
        className="hidden lg:inline-flex fixed z-40 lg:bottom-8 lg:right-8 text-[13px] lg:px-3.5 lg:py-2 rounded-lg backdrop-blur-md transition-all duration-300 hover:-translate-y-0.5"
        style={{
